...
import '../controller/p_settings_page_controller.dart';

class PSettingsPage extends StatelessWidget {
  PSettingsPage({super.key});

  PSettingsPageController controller = Get.put(PSettingsPageController());
                ...
                Visibility(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildMenuItem(
                        icon: "ic_service",
                        title: LangKeys.services.tr,
                        hasArrow: true,
                        isShowDivider: false,
                        onTap: () {
                          Get.toNamed(AppRoutes.pServicesPage);
                        },
                      ),
                      _buildMenuItem(
                        icon: "ic_work_times",
                        title: LangKeys.workingTimes.tr,
                        hasArrow: true,
                        isShowDivider: false,
                        onTap: () {
                          Get.toNamed(AppRoutes.pWorkTime);
                        },
                      ),
                      _buildMenuItem(
                        icon: "ic_ratings",
                        title: LangKeys.ratings.tr,
                        hasArrow: true,
                        isShowDivider: false,
                        onTap: () {
                          Get.toNamed(AppRoutes.pRatings);
                        },
                      ),
                    ],
                  ),
  ...
  Widget _buildProfileInfoCard() {
    return GetBuilder<PSettingsPageController>(
      id: 'updateUser',
      builder: (controller) {
