            ...
            children: [
              controller.order.value.status.toString() == "0"
                  ? Obx(
                    () => CustomTabBar(
                      tabs: [
                        TabItem(title: 'تفاصيل الخدمة'),
                        TabItem(title: 'العروض'),
                      ],
                      selectedIndex: controller.selectedTabIndex.value,
                      onTabChanged: (index) {
                        controller.selectedTabIndex.value = index;
                        controller.tabController.animateTo(index);
                        controller.update(['updateOrder']);
                      },
                ...
                child: Obx(() {
                  ...
                  if (controller.selectedTabIndex.value == 1) {
                    ...
                    return ListView.builder(
                      ...
                      itemCount: controller.order.value.orderOffers?.length,
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  AppCustomText(
                                    text:
                                        '${controller.order.value.orderOffers![index].price.toString()}',
                                    fontSize: 16.sp,
                                    fontWeight: FontWeight.w600,
                                    color: Color(0xFF4A90E2),
                                  ),
                              ...
                              Row(
                                children: [
                                  Expanded(
                                    child: AppButton(
                                      color: HexColor("63CB5B"),
                                      text: LangKeys.accept.tr,
                                      onPressed: () {
                                  ...
                                  Expanded(
                                    child: AppButton(
                                      color: HexColor("F36464"),
                                      text: LangKeys.reject.tr,
                                      onPressed: () {},
                                    ),
                                  ),
                                ],
                    ...
                    return SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          controller.order.value.provider != null
                              ? 12.verticalSpace
                              : SizedBox(),
                          controller.order.value.provider != null
                              ? Container(
                          ...
                          controller.order.value.canRate == true &&
                                  controller.order.value.isRated == false
                              ? Column(
                                children: [
                                  10.verticalSpace,
                                  AppButton(
                                    text: LangKeys.rating.tr,
                                    onPressed: () {
                                      controller.showRatingBottomSheet();
                                    },
                                  ),
                                ],
                              )
